...
export const MuseumIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 21h18M5 21V10.722a2 2 0 01.527-1.414l4.16-5.2a2 2 0 013.34 0l4.16 5.2a2 2 0 01.527 1.414V21M9 21v-5a2 2 0 012-2h2a2 2 0 012 2v5m-6 0h6" />
  </svg>
);
