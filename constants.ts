...
export const stylePresets: StylePreset[] = [
  {
    ...
    prompts: [
      ...
      'Professional headshot, wearing a charcoal grey pinstripe suit and a light blue shirt. Background is a tastefully blurred executive office with warm wood tones. Photorealistic, 8K, sharp focus on the eyes.',
  ...
  },
  {
    ...
    prompts: [
      ...
      'Modern tech-executive headshot. Wearing a stylish dark grey merino wool sweater. Background is a minimalist office with geometric light fixtures and a single green plant, softly blurred. Natural, approachable smile. Ultra-realistic, shot on a prime lens.',
  ...
  },
  {
    ...
    prompts: [
      ...
      'Timeless black and white studio portrait. Wearing a classic dark cashmere turtleneck. The lighting is soft, using a clamshell setup to create a gentle, flattering glow. Background is a solid, medium-grey canvas. Evokes a sense of quiet confidence and elegance.',
